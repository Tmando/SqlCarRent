...
CREATE TABLE `AddInvoice` (
  `addinvoiceID` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE `CarCheck` (
  `checkid` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE `PickupCar` (
  `pickupid` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE `Reservation` (
  `resid` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
